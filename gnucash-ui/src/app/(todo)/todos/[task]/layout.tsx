...
export default function TaskDetailPage({ params, children }: any) {
    ...
    return (
      <>
        ...
        {segment == 'change-status' ? (
          <div className='bg-yellow-100 shadow-lg container mx:auto'>{children} </div>
        ) : null}
        <ListItem
        ...
        {segment == 'add-comment' ? (
          <div className='bg-yellow-100 shadow-lg'>{children} </div>
        ) : null}
