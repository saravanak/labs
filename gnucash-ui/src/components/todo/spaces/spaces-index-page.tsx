    ...
    <>
      <Accordion type='multiple'>
        ...
        <AccordionItem value='item-2'>
          <AccordionTrigger
            className={triggerClassNames}
            data-test-action='expander-shared-spaces'
          >
            <FlexJustifySpread className='grow pr-4'>
              <div data-retour-step='shared-spaces'>Spaces shared with me</div>
              <CircledNumber
                value={sharedSpaces}
                data-test-data='heading-shared-spaces-count'
              />
            </FlexJustifySpread>
          </AccordionTrigger>
          <AccordionContent className='text-base pb-0'>
